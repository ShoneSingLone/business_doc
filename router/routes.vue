		...
		return [
			...
			_.$newRoute("/directive", ComponentPageRouterView, {
				children: [
					_.$newRoute(
						"/directive/ripple",
						"@/views/directive/directive/ripple/ripple.vue"
					),
					_.$newRoute(
			...
			_.$newRoute("/x-component", ComponentPageRouterView, {
				children: [
					_.$newRoute(
						"/x-component/x-item",
						"@/views/xComponent/DemoxItem/DemoxItem.vue"
					),
					_.$newRoute(
				...
				children: [
					...
					_.$newRoute("/component/data", ComponentRouterView, {
						children: [
							...
							_.$newRoute(
								"/component/data/icon",
								"@/views/component/data/icon/icon.vue"
							),
							_.$newRoute(
							...
							_.$newRoute(
								"/component/data/card",
								"@/views/component/data/card/card.vue"
							),
							_.$newRoute(
								"/component/data/tag",
								"@/views/component/data/tag/tag.vue"
							),
							_.$newRoute(
								"/component/data/tree",
			...
			_.$newRoute("/other", ComponentPageRouterView, {
				children: [
					...
					_.$newRoute(
						"/other/notification",
						"@/views/other/notification/Notification.vue"
					),
