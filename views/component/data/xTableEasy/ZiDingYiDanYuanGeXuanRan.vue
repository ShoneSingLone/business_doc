...
`,
				tableData: [
					{ id: 1, name: "张三", age: 18, sex: "男", phone: "13800000001", address: "上海市普陀区金沙江路 1518 弄", status: 1, score: 95 },
					{ id: 2, name: "李四", age: 20, sex: "女", phone: "13800000002", address: "上海市浦东新区张江高科技园区", status: 2, score: 88 },
					{ id: 3, name: "王五", age: 22, sex: "男", phone: "13800000003", address: "北京市海淀区中关村大街 1 号", status: 3, score: 76 },
					{ id: 4, name: "赵六", age: 25, sex: "女", phone: "13800000004", address: "广州市天河区天河路 385 号", status: 1, score: 92 },
					{ id: 5, name: "钱七", age: 28, sex: "男", phone: "13800000005", address: "深圳市南山区科技园南区", status: 2, score: 84 }
				],
				columns: [
					...
					{ 
						...
						width: 80, 
						align: "center",
						cellRenderer: (row) => row.sex === "男" ? `<span style="color: blue;">${row.sex}</span>` : `<span style="color: pink;">${row.sex}</span>`
					},
					{ 
						field: "status", 
						key: "status", 
