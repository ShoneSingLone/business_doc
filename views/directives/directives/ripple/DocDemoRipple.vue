<template>
	<DocContentOfDemo class="ViewRipple">
		...
		<DemoAndCode title="基础用法" path="@/views/directives/ripple/JiChuYongFa.vue" unfold />
		<DemoAndCode title="自定义颜色" path="@/views/directives/ripple/ZiDingYiYanSe.vue" unfold />
