<template>
	<DocContentOfDemo class="ViewRipple">
		...
		<DemoAndCode
			title="基础用法"
			path="@/views/directives/infinite_scroll/JiChuYongFa.vue"
			unfold />
		<DemoAndCode
			title="Scroll Up"
			path="@/views/directives/infinite_scroll/scroll_up.vue"
			unfold />
		<DemoAndCode
			title="禁用加载"
			path="@/views/directives/infinite_scroll/jin_yong_jia_zai.vue"
			unfold />
